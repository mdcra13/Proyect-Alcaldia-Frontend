...
import SeguimientoNotas from '@/components/departamento/SeguimientoNotas'
...
const solicitudSeguimiento: Solicitud = {
  id: '1001',
  radicado: '#1001',
  ...
  historial: [
    ...
    },
    {
      ...
      fecha: '2024-03-16',
      accion: 'signed',
      descripcion: 'Solicitud firmada por Alcaldía',
...
describe('SeguimientoNotas', () => {
  ...
  it('has no accessibility violations on initial render', async () => {
    const { container } = renderSeguimientoNotas()
